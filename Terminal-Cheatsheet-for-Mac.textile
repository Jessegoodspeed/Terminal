...
| mkdir -p [folder]/[folder] | Create nested directories |
...
| > [file.txt] | Push output to file, keep in mind it will get overwritten |
| >> [file.txt] | Append output to existing file |
